...
static UIImage *animatedImageWithAnimatedGIFImageSource(CGImageSourceRef const source) {
    ...
    UIImage *const animation = [UIImage animatedImageWithImages:frames duration:(NSTimeInterval)totalDurationCentiseconds/20 ];
...
- (instancetype)init {
    if ((self = [super initWithFrame:CGRectMake(30, 502, 300, Size)])) {
